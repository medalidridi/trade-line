...
<table class="table table-bordered table-hover"   >
  ...
  ?>
                                                                                                                                                                 <tr> 
                                                                                                                                                                                                                                                                                    <td><a href="boite_message.php?id=<?php echo $id;?>&id1=<?php echo $res[$i]['id']; ?>&id2=<?php echo $res[$i]['id']; ?>"><?php echo $res[$i]['nom'];?></a></td>
                                    
    
                                    
                                    
                                   <td> <a href="boite_message.php?id=<?php echo $id;?>&id1=<?php echo $res[$i]['id']; ?>&id2=<?php echo $res[$i]['id']; ?>"><?php echo $res[$i]['email'];?></a></td>
