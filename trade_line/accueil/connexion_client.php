                    ...
                    <div class="container">
                        <div class="row"> 
                            ...
                            <div class="span6">
                                ...
                                <form method="post" action="control/connect_client.php" >

                                   
                                    <input type="text" name="login" id="login"  class=""/>

                                   
                                    <input id="pwdeye" type="password" name="pwd" id="pwd" class=""/><a onMouseDown="showpwd()">click here</a>
...
<li> <a href="formulaire_client.php">cree un compte</a> </li>
</ul>                               
