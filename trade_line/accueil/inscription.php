            ...
            <section id="content" >
                ...
                <header class="headerPage">
                    <div class="container clearfix">
                        <div class="row">
                            <h1 class="span8">Inscription <span> </span></h1>
                    ...
                    <div class="row">
                        <div id="contactinfoWrapperPage" class="clearfix">
                            ...
                            <div class="span6">
                                ...
                                <form method="post" action="control/addentreprise.php" id="contactform" enctype="multipart/form-data">

                                    <label for="name"></label>
                                    <input type="text" name="nom" id="name" placeholder="Name" class=""/>
                                    
                                   
                                    
                                     <label for="pwd"></label>
                                    <input type="password" name="pwd" id="pwd" placeholder="pwd" class=""/>
                                    
                                    <label for="email"></label>
                                    <input type="text" name="email" id="email" placeholder="Email" class=""/>
                                    
                                    <label for="description"></label>
                                    <textarea name="description" id="description" cols="3" rows="5" placeholder="description" class=""></textarea>
                                    


                                    <label for="phone"></label>
                                    <input name="tel" type="text" id="phone" size="30" value="" placeholder="Phone"/>

                                    <label for="adresse"></label>
                                    <input type="text" name="adresse" id="adresse" placeholder="adresse" class=""/>
                                    
                                    <label for="logo"></label>
                                    <input type="file" name="logo" id="logo" placeholder="logo" class=""/>
