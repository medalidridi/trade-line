                    ...
                    <div class="row">
                        <div id="contactinfoWrapperPage" class="clearfix">
                            ...
                            <div class="span6">
                                ...
                                <form action="control/modif_livraison.php?id=<?php echo $id; ?>" method="post">

                                    
                                     <h3 class="page-subheading">choisissez votre methode de paiement </h3>                                                                                                                                                            
                                            <table>
                                            <tr><td>
                         <p><label for="paiement electronique">  </label> <input type="radio" name="livraison" id="paiement_electronique" value="livraison à domicile" class="" required/> &nbsp;livraison à domicile </p> </td><td><i class="icon-home" style="
    font-size: 300%;
    margin-left: 38px;
"></i></td>
