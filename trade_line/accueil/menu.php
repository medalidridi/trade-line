   ...
   <nav id="mainMenu" class="clearfix">
            ...
            <form method="get" action="produit_rechercher.php"   Style="margin-top: 28px;margin-right: 17px;">
                               ...
                               <li><a href="connexion_entreprise.php" class="firstLevel" >Espace Entreprise</a>
                                	<ul>
                                 			<li><a href="../entreprise/connexion_entreprise.php" class="firstLevel">Se Connecter</a></li>
                                  			<li><a href="../entreprise/formulaire_entreprise.php" class="firstLevel">Creer Compte</a></li>
                                  	</ul>
                                </li>


                                <li><a href="#" class="firstLevel">à propos</a>
                                    <ul >
                                         
                                         <li><a href="faq.php">FAQ</a></li>
                                         <li><a href="offre_fb.php">offres facebook</a></li>
