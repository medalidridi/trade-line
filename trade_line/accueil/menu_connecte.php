...
<li><h3 style="margin-left: -40%;margin-top: 21%;"> Bienvenue   <?php echo $res['nom']; ?> </h3></li>
           ...
           <form method="post" action="blog-home.html" Style="margin-top: 28px;margin-right: 17px;">
                                ...
                                <span style="margin-left:-5px;"> 
                                   ...
                                   <li><a href="index_c.php?id_client=<?php echo $id ?>" class="firstLevel active">Accueil</a></li>
                                   <li><a href="profil_client.php?id=<?php echo $id ?>" class="firstLevel ">Profil</a></li>
