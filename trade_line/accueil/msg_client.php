...
?>
                                <form method="post" action="control/envoyer_message.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" >
                                    ...
                                    <input type="text" name="email" id="email" value="<?php echo $res['email'];?>" class="" placeholder="e-mail" required/>
                                                 ...
                                                 <input name="tel" type="text" id="phone" size="30" value="" value="<?php echo $res['tel'];?>" placeholder="tel"/>
                                    
                                    
                                 
                                    <textarea name="msg" id="msg" cols="3" rows="5" placeholder="message" required/></textarea>
                                    



                                    <button name="envoyer" type="submit" class="btn" id="submit"> envoyer</button>
