            ...
            <section id="content" class="portfolio postview">
                ...
                <header class="headerPage">
                    <div class="container clearfix">
                        <div class="row">
                            <h1 class="span8">VERTICAL <span>portfolio</span></h1>
                            <div class="span4" id="navTrail"> 
                                <a href="index.php" class="homeLink">home</a><span>/</span><a href="portfolio-2columns.html">portfolio</a><span>/</span><span class="current">vertical</span>
                            </div>
                        </div>
                    </div>
                </header>    
