	...
	?>
                         ...
                         <span class="iconWrapper iconLink"><i class="icon-basket">
                              ...
                              <section class="hiddenInfo">
                                        ...
                                        <h3>Prix : <?php echo $res[$i]['prix'];?> TND</h3>
                                        <h3>stock :<?php echo $res[$i]['stock'];?></h3>
                                        <p class="boxTextWrapper"><a href="vue_produit.php?id=<?php echo $res[$i]['id'];?>" class="moreLink">&rarr; read more</a></p>
                                  </section>
                                </article>
<?php }?>
