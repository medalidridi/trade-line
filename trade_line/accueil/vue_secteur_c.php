	...
	?>
                         ...
                         <span class="iconWrapper iconLink"><i class="icon-basket">
                              ...
                              <section class="hiddenInfo">
                                        <h3>Nom produit : <?php echo $res[$i]['nom'];?></h3>
                                        <h3>Prix : <?php echo $res[$i]['prix'];?> TND</h3>stock :<?php echo $res[$i]['stock'];?>
                                         <p><a href="control/add_favorits.php?id=<?php echo $res[$i]['id'];?>&id_client=<?php echo $id_client ?>" class="btn btn-3d btnSmall">&rarr; Ajout au favorits</a></p>
                                        <p><a href="vue_produit_c.php?id=<?php echo $res[$i]['id'];?>&id_client=<?php echo $id_client ?>" class="btn btn-3d btnSmall">&rarr; read more</a></p>
