...
<div class="all-wrapper fixed-header left-menu">
  ...
  <div class="main-content">
    <ol class="breadcrumb">
       <button type="button" class="btn btn-primary btn-xs " > <a href="ajout_admin.php" Style="color:white !important;" >Ajouter</a></button>
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
        ...
        <h3><i class="icon-table"></i>Admin</h3>
      </div>
...
?>
  ...
  ?>
            <tr>
              ...
              <td><?php echo $res[$i]['login']; ?></td>
              <td>********</td>
              <td class="text-right"><a href="modif_admin.php?id=<?php echo $res[$i]['id']; ?>" class="btn btn-default btn-xs">Modifier</a> <a href="control/supp_admin.php?id=<?php echo $res[$i]['id']; ?>" ><img src="images/icon_suppression.png" width="30" height="30"></a></td>
            </tr>
            <?php } ?>
          </tbody>
          <tbody>
