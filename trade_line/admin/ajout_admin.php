...
<div class="all-wrapper fixed-header left-menu">
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
            ...
            <h3><i class="icon-ok-sign"></i> Ajouter admin</h3>
          </div>
          <div class="widget-content">
          <form action="control/adadmin.php" method="post">
<table width="347" border="0">
  <tr>
    <td width="69">login</td>
    <td width="268"><input type="text" name="login"  class="form-control"id="login" /></td>
  </tr>
  <tr>
    <td>pwd</td>
    <td><input type="text" name="pwd"  class="form-control"id="pwd" /></td>
  </tr>
   <tr>
    <td></td>
