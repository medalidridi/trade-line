...
?>
  ...
  ?>            <tr>
              ...
              <td class="text-right"><a href="modif_categorie.php?id=<?php echo $res[$i]['id']; ?>" class="btn btn-default btn-xs">Modifier</a> <a href="control/supp_categorie.php?id=<?php echo $res[$i]['id']; ?>" ><img src="images/icon_suppression.png" width="30" height="30"></a></td>
            </tr>
            <?php } ?>
          </tbody>
          <tbody>
