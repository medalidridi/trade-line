...
?>
  ...
  ?>
            <tr>
              ...
              <td><?php echo $res[$i]['tel']; ?></td>
              <td><?php echo $res[$i]['civilite']; ?></td>
              <td><?php echo $res[$i]['login']; ?></td>
              <td><?php echo $res[$i]['pwd']; ?></td>
              <td class="text-right"><a href="client_det.php?id=<?php echo $res[$i]['id']; ?>"class="btn btn-default btn-xs">Detail</a></a> <a href="control/supp_client.php?id=<?php echo $res[$i]['id']; ?>"><img src="images/icon_suppression.png" width="30" height="30"></a></td>
            </tr>
            <?php } ?>
          </tbody>
          <tbody>
