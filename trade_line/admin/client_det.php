...
<div class="all-wrapper fixed-header left-menu">
  ...
  <div class="main-content">
    <ol class="breadcrumb">
      <button type="button" class="btn btn-primary btn-xs " > <a href="client.php" Style="color:white !important;" >Retour</a></button>
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
        ...
        <h3><i class="icon-table"></i>Client</h3>
      </div>
...
?>
            ...
            <tr>
              ...
              <td><?php echo $res['code_postal']; ?></td>
