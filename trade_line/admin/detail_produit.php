...
<div class="all-wrapper fixed-header left-menu">
  ...
  <div class="main-content">
    ...
    <button type="button" class="btn btn-primary btn-xs " > <a href="commande.php" Style="color:white !important;" >Retour</a></button>
    </ol>
    <div class="row"></div>
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
        ...
        <h3><i class="icon-table"></i>ProDUIT</h3>
      </div>
      <div class="widget-content">
        <div class="table-responsive">
          ...
          <thead>
            <tr>
              ...
              <th style="width: 8%;">ID_produit</th>
              <th>photo</th>
              <th>nom produit</th>
              <th>quantité</th>
              <th>prix unitaire</th>
		...
		$u=new panier();
		$res=$u->affpanierbyid_commande($id);
		
		$y=new panier();
		$result=$y->affNomEntreprise();
		
		$v=new panier();
		$resultat=$v->Affproduit_panier0();
		
		
		$w=new panier();
		$resi=$w->Affproduit_panier1();
		?>
  ...
  ?>
            <tr>
              ...
              <td><img src="../entreprise/produit/<?php echo $resi[$i]['photo'];?>" width="150px" height="120px"/></td>
              <td><?php echo $resultat[$i]['nom']; ?></td>
              <td><?php echo $res[$i]['qte']; ?></td>
              <td><?php echo $res[$i]['prix']; ?></td>
              <td><?php echo $result[$i]['nom']; ?> &nbsp; <a href="detail_entreprise.php?id=<?php echo $result[$i]['id']; ?>" class="btn btn-default btn-xs">Details</a></td>
