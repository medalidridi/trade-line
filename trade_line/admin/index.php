...
<div class="all-wrapper fixed-header left-menu">
  ...
  <div class="header-links hidden-xs">
    <div class="dropdown hidden-sm hidden-xs"></div>
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
        ...
        <h3><i class="icon-table"></i>Authentification</h3>
      </div>
      <div class="widget-content"><form action="control/authentification.php" method="post" enctype="multipart/form-data">
<table  border="0">
 
  
  <tr>
    <td width="35">login:</td>
    <td width="449"><input name="login" type="text" class="form-control" /></td>
  </tr>
  <tr>
    <td>password:</td>
  ...
  <tr>
    <td></td>
    <td><input type="submit" name="connecter"class="btn btn-primary" id="modifier" value="connecter" /></td>
  </tr>
</table>
