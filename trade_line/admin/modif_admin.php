...
<div class="all-wrapper fixed-header left-menu">
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
            ...
            <h3><i class="icon-ok-sign"></i> Modifier admin</h3>
          </div>
...
$u=new admin();
$res=$u->affadminbyid($id);

?>
<form action="control/modadmin.php?id=<?php echo $res['id'];?>" method="POST">
<table  border="0">
 
  
  <tr>
    <td>login :</td>
    <td><input name="login" type="text" class="form-control" id="login" value="<?php echo $res['login'];?>" /></td>
  </tr>
  <tr>
    <td>mot de passe :</td>
    <td><input type="password" name="pwd"class="form-control" id="pwd"  value="<?php echo $res['pwd'];?>"/></td>
  </tr>
