...
<div class="all-wrapper fixed-header left-menu">
  ...
  <h1>Espace Modifier categorie</h1>
</div>
  <div class="side">
  ...
  <a href="#" class="widget-control widget-control-remove" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"><i class="icon-remove-sign"></i></a>
            ...
            <h3><i class="icon-ok-sign"></i> Modifier categorie</h3>
          </div>
...
$u=new secteur();
$res=$u->affsecteurbyid($id);

?>
<form action="control/modsecteur.php?id=<?php echo $res['id'];?>" method="post">
<table  border="0">
