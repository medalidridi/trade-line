...
<div class="all-wrapper fixed-header left-menu">
  ...
  <div class="main-content">
    ...
    <button type="button" class="btn btn-primary btn-xs " > <a href="vueproduit.php" Style="color:white !important;" >Ajouter</a></button>
    </ol>
    <div class="row"></div>
...
?>
  ...
  ?>
            <tr>
              ...
              <td class="text-right"><a href="modif_produit.php?id=<?php echo $res[$i]['id']; ?>" class="btn btn-default btn-xs">Modifier</a> <a href="control/supp_produit.php?id=<?php echo $res[$i]['id']; ?>" ><img src="images/icon_suppression.png" width="30" height="30"></a></td>
            </tr>
            <?php } ?>
          </tbody>
          <tbody>
