...
<div class="all-wrapper fixed-header left-menu">
  ...
  <div class="main-content">
    <ol class="breadcrumb">
      <li></li>
     <a href="vueentreprise.php">ajouter</a>
    </ol>
    <div class="row"></div>
...
<table width="259" border="1">
  ...
  <tr>
    <td>logo :</td>
    <td><input name="logo" type="image" /></td>
  </tr>
  <tr>
    <td>secteur :</td>
  ...
  <tr>
    <td>autorisation :</td>
    <td>false<input name="autorisation" type="checkbox" disabled="disabled" value="true " checked="checked" />
    true<input name="autorisation" type="checkbox" disabled="disabled" value="true " checked="checked" /></td>
  </tr>
  <tr>
    <td></td>
    <td><input type="submit" name="envoyer" id="envoye" value="envoyer" /></td>
  </tr>
</table>
