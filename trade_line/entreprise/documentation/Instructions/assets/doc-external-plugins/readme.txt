...
To include the form on your existing HTML page, open index.php in a text / web editor (Notepad / Dreamweaver) copy the code between the opening <body> and closing </body> tags and Paste it into the relevant position in your existing page.
