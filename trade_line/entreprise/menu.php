...
<html lang="en">
 ...
 $(".popupbg").addClass("impobg");
    ...
    <body>
     ...
     <a href="index.php" class="brand"><img src="images/logo/logo.png"  alt="Trade line"/></a>
   <nav id="mainMenu" class="clearfix">
                    ...
                    <li Style="float: right;margin-top: -11px;">
                               ...
                               <li >
           <form method="get" action="#" target="w_out" Style="margin-top: 28px;margin-right: 17px;">
                                ...
                                <span style="margin-left:-5px;"> 
                                   ...
                                   <li><a href="../accueil/index.php" class="firstLevel active">Accueil</a></li>
                                
                                
                                	<li><a href="../accueil/connexion_client.php" class="firstLevel">Espace Client</a>
                                       <ul>
                                 			<li><a href="../accueil/connexion_client.php" class="firstLevel">Se Connecter</a></li>
                                 			<li><a href="../accueil/formulaire_client.php" class="firstLevel">Creer Compte</a></li>
                                 	   </ul>
                                       </li>
                               ...
                               <li><a href="connexion_entreprise.php" class="firstLevel" >Espace Entreprise</a>
                                ...
                                <li><a href="template-columns.html" class="firstLevel">à propos</a>
                                    <ul >
                                         ...
                                         <li><a href="contact.php" class="firstLevel last">Contact</a>
