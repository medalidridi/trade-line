...
?>
   ...
   <nav id="mainMenu" class="clearfix">
                    ...
                    <li Style="float: right;margin-top: -11px;">
                               ...
                               <li>
           <form method="get" action="produit_rechercher.php?id=<?php echo $id; ?>" Style="margin-top: 28px;margin-right: 17px;">
                               ...
                               <?php $id=$_GET['id']; ?>
                               <li><a href="profil_entreprise.php?id=<?php echo $id; ?>" class="firstLevel active">Profil</a></li>
